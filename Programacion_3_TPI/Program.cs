...
{
    setupAction.AddSecurityDefinition("Programacion_3_TPI", new OpenApiSecurityScheme()
    {
...
{
    options.AddPolicy("OwnerPolicy", policy => policy.RequireRole("Admin"));
